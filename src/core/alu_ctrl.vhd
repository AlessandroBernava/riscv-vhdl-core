-- ALU Control: riceve ALUOp dalla Control Unit (2 bit che indicano la categoria
-- dell'operazione) e produce il codice a 4 bit per la ALU.
--
...
-- In questo modo sfruttiamo la codifica nativa dell'ISA (filtrata leggermente,
-- forzando bit30 a 0 quando non serve).
--
