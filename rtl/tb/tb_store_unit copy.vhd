...
entity tb_store_unit is
end entity tb_store_unit;

architecture tb of tb_store_unit is
    ...
    signal   byte_enable_o_t   : std_logic_vector(3 downto 0);
...
begin
    ...
    begin
        ...
        report " formatted store data got " & to_hstring(formatted_data_o_t)
        severity note;
        report " misaligned got " & std_logic'image(misaligned_o_t)
        severity note;
        report " byte enable got " & to_bstring(byte_enable_o_t)
        severity note;
